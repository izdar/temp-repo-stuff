...
// Include AFL headers first
#include "../config.h"
#include "../types.h"
#include "../debug.h"

// Undefine problematic macros that conflict with LLVM
#undef R
#define AFL_R(x) (random() % (x))

// Now include LLVM headers
// #include <llvm/...>
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
#include "llvm/Pass.h"  // ADD THIS LINE
...
bool AFLCoverage::runOnModule(Module &M) {
  ...
  fprintf(stderr, "*** AFL PASS IS RUNNING ***\n");
