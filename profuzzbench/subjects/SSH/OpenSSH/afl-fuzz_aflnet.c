      ...
      case 'P': /* protocol to be tested */
        ...
        if (!strcmp(optarg, "RTSP")) {
          if (!g_monitor_initialized) {
            ...
            if (!eval_path) eval_path = "/usr/local/bin/formula_parser";
            if (!spec_path) spec_path = "/home/ubuntu/monitor/live555.txt";
          ...
          if (!g_monitor_initialized) {
            eval_path = getenv("LTL_EVAL_PATH") ?: "/usr/local/bin/formula_parser";
            spec_path = getenv("LTL_SPEC_PATH") ?: "/home/ubuntu/monitor/lightftp.txt";
          ...
          if (!g_monitor_initialized) {
            ...
            if (!eval_path) eval_path = "/usr/local/bin/formula_parser";
            if (!spec_path) spec_path = "/home/ubuntu/monitor/ssh-refined.txt";
